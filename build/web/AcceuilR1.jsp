...
<ul style="color: white;font-style: italic;font-size: 20px;">
    <li><a href="Personnel.jsp">Acceuil</a></li>
  ...
  <li>
    <div class="form-group input-sm">
        <div style="padding-top:5%; ">
            <input class="form-control" type="text" name="nar" placeholder="Rechercher"  required>
        </div>
    </div>
  </li>
  <li>
...
<div class="util">
<%List < Utilisateur > allu = UDAO.searchUsers(Uservlet.getNar(),Uservlet.getNomU());
