...
<div id="id01" class="modal"> 
    ...
    <div class="imgcontainer">
      ...
      <img  alt="Pas de photo de profil" class="pdp" src=<%=session.getAttribute("pdp").toString()%>>
    </div>
    <div class="container">
    ...
    <div id="id1" class="mod" style="display:${disp}"> 
        <div class="container" >
            <a style="color:#006080" href="Messages.jsp"><img src="icons/retour.png"></a>
            <label  class="control-label col-3" style="color: white;"><%=Uservlet.getNr()%></label>
        </div>
